...
- **No program guide** — Guide data is a v0.2 candidate. HDHomeRun per-channel streams carry no
  PSIP tables, so an in-band guide needs a full-multiplex crawl or XMLTV.
