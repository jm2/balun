...
| Network-change handling | 🚧 Linux, macOS, and Windows: stale addresses expire when adapters, addresses, or routes change, and nothing rescans on its own; Linux routed scans also stop; macOS and Windows await real-network confirmation |
