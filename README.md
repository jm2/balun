...
| Native runtime inventory tooling | 🛠️ Exact membership/content validation and native-scope SBOM generation; [platform collection and release attachment remain pending](docs/native-inventory.md) |
