...
| Native runtime inventory tooling | 🛠️ Final-tree hashing, macOS native copy ownership, installed Homebrew metadata, and native-scope SBOM generation; [catalog assembly and release attachment remain pending](docs/native-inventory.md) |
