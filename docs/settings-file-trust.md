...
Status: proposed H3.2 contract, awaiting maintainer decisions. This document
does not complete H3.2 or claim the implementation already enforces it.
...
This proposed boundary excludes shared profiles, network filesystems, malicious
...
Proposed exception owner: `jm2`. Revisit before beta, profile import/export/sync,
...
## Proposed responsiveness and durability tradeoff
