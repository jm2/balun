...
user-facing fixes shipped in v0.2.0 on 2026-09-25. The maintainer
accepted the published v0.1.1 packages on Linux, macOS, and Windows (P4.1); the
IPv6 discovery defect fixed in v0.2.0 surfaced later in review. H0 is complete. By
...
- [ ] **V2.6 — Localize the interface ([#74]).** Extend the [foundation](localization.md)
  with complete interface/CLI translation, pluralization, and accessibility copy;
  verify catalog keys and long-string layouts across all supported locales.
